...
@Config(modid = COre.MODID, name = "cOre/Flarite Ore")
@Config.LangKey("core.config.title_flarite")
public class FlariteConfig {
	...
	public static class WorldGen {
		...
		public String[] allowedBiomes = new String[]{"ocean","swampland","river","beaches","jungle","jungle_hills","jungle_edge","deep_ocean",};
	}
	
	public static class Drops {
		@Config.Comment(_ConfigValues.primaryDroppedItem)
		public String primaryDroppedItem = "core:ore_flarite";
		@Config.Comment(_ConfigValues.secondaryDroppedItem)
		public String secondaryDroppedItem = "core:nugget_flarite";
	...
	public static class OreDictionary {
		...
		public String ingotOreDict = "ingotFlarite";
		@Config.Comment(_ConfigValues.oreOreDict)
		public String oreOreDict = "oreFlarite";
		@Config.Comment(_ConfigValues.dustOreDict)
		public String dustOreDict = "dustFlarite";
		@Config.Comment(_ConfigValues.dustImpureOreDict)
		public String dustImpureOreDict = "dustImpureFlarite";
		@Config.Comment(_ConfigValues.dustTinyOreDict)
		public String dustTinyOreDict = "dustTinyFlarite";
		@Config.Comment(_ConfigValues.nuggetOreDict)
		public String nuggetOreDict = "nuggetFlarite";
		@Config.Comment(_ConfigValues.blockOreDict)
		public String blockOreDict = "blockFlarite";
	}
