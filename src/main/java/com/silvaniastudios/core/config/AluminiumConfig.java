...
@Config(modid = COre.MODID, name = "cOre/Aluminium Ore")
@Config.LangKey("core.config.title_aluminium")
public class AluminiumConfig {
	...
	public static class Drops {
		...
		public String primaryDroppedItem = "core:ore_aluminium";
		@Config.Comment(_ConfigValues.secondaryDroppedItem)
		public String secondaryDroppedItem = "core:nugget_aluminium";
	...
	public static class OreDictionary {
		@Config.Comment("Automatically add \"Aluminum\" variants to all oredict entries, in addition to the ones listed below.\n"
				+ "(If this is true and you're keeping defaults, leave the others with the I in."
				+ "\nY'know, the CORRECT spelling of the word. ;)")
		public boolean americanSupport = true;
		@Config.Comment(_ConfigValues.ingotOreDict)
		public String ingotOreDict = "ingotAluminium";
		@Config.Comment(_ConfigValues.oreOreDict)
		public String oreOreDict = "oreAluminium";
		@Config.Comment(_ConfigValues.dustOreDict)
		public String dustOreDict = "dustAluminium";
		@Config.Comment(_ConfigValues.dustImpureOreDict)
		public String dustImpureOreDict = "dustImpureAluminium";
		@Config.Comment(_ConfigValues.dustTinyOreDict)
		public String dustTinyOreDict = "dustTinyAluminium";
		@Config.Comment(_ConfigValues.nuggetOreDict)
		public String nuggetOreDict = "nuggetAluminium";
		@Config.Comment(_ConfigValues.blockOreDict)
		public String blockOreDict = "blockAluminium";
	}
	...
	public static class Recipes {
		...
		public String oreCrusherPrimaryOutput = "core:dust_impure_aluminium";
		...
		public String oreCrusherSecondaryOutput = "core:dust_tiny_aluminium";
		...
		public String ingotCrusherOutput = "core:dust_aluminium";
		...
		public String nuggetCrusherOutput = "core:dust_tiny_aluminium";
		...
		public String oreSmeltingOutput = "core:ingot_aluminium";
		...
		public String dustSmeltingOutput = "core:ingot_aluminium";
		...
		public String dustImpureSmeltingOutput = "core:ingot_aluminium";
		...
		public String dustTinySmeltingOutput = "core:nugget_aluminium";
