...
@Config(modid = COre.MODID, name = "cOre/Alloy Bronze")
@Config.LangKey("core.config.title_bronze")
public class AlloyBronzeConfig {
	...
	public static class OreDictionary {
		...
		public String ingotOreDict = "ingotBronze";
		@Config.Comment(_ConfigValues.dustOreDict)
		public String dustOreDict = "dustBronze";
		@Config.Comment(_ConfigValues.dustTinyOreDict)
		public String dustTinyOreDict = "dustTinyBronze";
		@Config.Comment(_ConfigValues.nuggetOreDict)
		public String nuggetOreDict = "nuggetBronze";
		@Config.Comment(_ConfigValues.blockOreDict)
		public String blockOreDict = "blockBronze";
		@Config.Comment(_ConfigValues.fluidName)
		public String fluidName = "fluidBronze";
	}
	...
	public static class Recipes {		
		...
		public String ingotCrusherOutput = "core:dust_bronze";
		...
		public String nuggetCrusherOutput = "core:dust_tiny_bronze";
		...
		public String dustSmeltingOutput = "core:ingot_bronze";
		...
		public String dustTinySmeltingOutput = "core:nugget_bronze";
