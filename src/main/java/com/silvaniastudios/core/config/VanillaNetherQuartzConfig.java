...
@Config(modid = COre.MODID, name = "cOre/NetherQuartz Ore")
@Config.LangKey("core.config.title_nether_quartz")
public class VanillaNetherQuartzConfig {
	...
	public static class WorldGen {
		...
		public int minWorldHeight = 7;
		@Config.Comment(_ConfigValues.maxWorldHeight)
		public int maxWorldHeight = 117;
	...
	public static class Drops {
		...
		public String primaryDroppedItem = "minecraft:quartz";
		@Config.Comment(_ConfigValues.secondaryDroppedItem)
		public String secondaryDroppedItem = "core:dust_nether_quartz";
	...
	public static class OreDictionary {
		...
		public String dustOreDict = "dustNetherQuartz";
		@Config.Comment(_ConfigValues.dustTinyOreDict)
		public String dustTinyOreDict = "dustTinyNetherQuartz";
	}
