...
@Config(modid = COre.MODID, name = "cOre/Calcite Ore")
@Config.LangKey("core.config.title_calcite")
public class CalciteConfig {
	...
	public static class Drops {
		...
		public String primaryDroppedItem = "core:dust_calcite";
	...
	public static class OreDictionary {
		...
		public String oreOreDict = "oreCalcite";
	}
	...
	public static class Recipes {
		...
		public String oreCrusherPrimaryOutput = "core:dust_calcite";
