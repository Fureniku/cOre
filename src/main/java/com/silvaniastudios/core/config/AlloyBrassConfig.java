...
@Config(modid = COre.MODID, name = "cOre/Alloy Brass")
@Config.LangKey("core.config.title_brass")
public class AlloyBrassConfig {
	...
	public static class OreDictionary {
		...
		public String ingotOreDict = "ingotBrass";
		@Config.Comment(_ConfigValues.dustOreDict)
		public String dustOreDict = "dustBrass";
		@Config.Comment(_ConfigValues.dustTinyOreDict)
		public String dustTinyOreDict = "dustTinyBrass";
		@Config.Comment(_ConfigValues.nuggetOreDict)
		public String nuggetOreDict = "nuggetBrass";
		@Config.Comment(_ConfigValues.blockOreDict)
		public String blockOreDict = "blockBrass";
		@Config.Comment(_ConfigValues.fluidName)
		public String fluidName = "fluidBrass";
	}
