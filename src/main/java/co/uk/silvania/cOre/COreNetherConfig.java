...
public class COreNetherConfig {
	...
	public static void loadConfig(FMLPreInitializationEvent event) {
		...
		platinumMax = config.get(CATEGORY_PLATINUM, "Platinum Max OPV", 2).getInt();
		...
		promethiumMin = config.get(CATEGORY_PROMETHIUM, "Promethium Min OPV", 1).getInt();
		...
		iridiumMin = config.get(CATEGORY_IRIDIUM, "Iridium Min OPV", 1).getInt();
